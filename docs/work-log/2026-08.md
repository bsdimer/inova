...
- Kept `.cursor/skills/sosedo-frontend/` as the canonical project workflow and
...
- Added small/feature/domain/bug routes, an optional feature brief, risk-based
  TDD guidance, and a concise Sosedo clean-code profile derived from
...
- Split living status out of `implementation-status.md` into `docs/current.md`
  ...
  `.cursor/rules/sosedo-harness.mdc` and frontend skill
  `.cursor/skills/sosedo-frontend/`.
